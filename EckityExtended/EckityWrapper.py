...
class EckityWrapper:
    ...
    def setup_dnc(self, embedding_dim:int=64, population_size:int=100, logging:bool=False):
        ...
        self._crossover_op = self._eckitty_factory.create_dnc_op(individual_creator=self._creator, evaluator=self._evaluator, individual_length=self._individual_length, population_size=population_size, embedding_dim=embedding_dim, loggers=loggers, log_events=[BEFORE_TRAIN_EVENT_NAME, AFTER_TRAIN_EVENT_NAME], batch_size=32)        
